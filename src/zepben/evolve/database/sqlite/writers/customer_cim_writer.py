...
from zepben.evolve.database.sqlite.tables.iec61968.customer_tables import TableCustomers, TableCustomerAgreements, TablePricingStructures
...
class CustomerCIMWriter(BaseCIMWriter):
    ...
    def save_agreement(self, table: TableAgreements, insert: PreparedStatement, agreement: Agreement, description: str) -> bool:
        return self.save_document(table, insert, agreement, description)
    ...
    def save_customer(self, customer: Customer) -> bool:
        ...
        insert.add_value(table.num_end_devices.query_index, 0)  # Unused
    ...
    def save_customer_agreement(self, customer_agreement: CustomerAgreement) -> bool:
        ...
        if customer_agreement.customer is not None:
            insert.add_value(table.customer_mrid.query_index, customer_agreement.customer.mrid)
    ...
    def save_pricing_structure(self, pricing_structure: PricingStructure) -> bool:
        ...
        return status and self.save_document(table, insert, pricing_structure, "PricingStructure")
