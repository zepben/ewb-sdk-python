...
class DirectionalCurrentRelay(ProtectionRelayFunction):
    ...
    :var directional_characteristic_angle: [ZBEX] The characteristic angle (in degrees) that defines the boundary between the operate and restrain regions of
    ...
    :var polarizing_quantity_type: [ZBEX] Specifies the type of voltage to be used for polarization. This guides the selection/derivation of voltage from the VTs.
    :var relay_element_phase: [ZBEX] The phase associated with this directional relay element. This helps in selecting the correct 'self-phase' or other phase-derived.
    :var minimum_pickup_current: [ZBEX] The minimum current magnitude required for the directional element to operate reliably and determine direction. This might be different from
    the main pickupCurrent for the overcurrent function.
    :var current_limit_1: [ZBEX]Current limit number 1 for inverse time pickup in amperes.
    :var inverse_time_flag: [ZBEX] Set True if the current relay has inverse time characteristics.
    :var time_delay_1: [ZBEX] Inverse time delay number 1 for current limit number 1 in seconds.
    """
