...
class Substation(EquipmentContainer):
    ...
    def _retype(self):
        self.normal_energized_feeders: MRIDListRouter[Feeder] = ...
        self.loops: MRIDListRouter[Loop] = ...
        self.energized_loops: MRIDListRouter[Loop] = ...
        self.circuits: MRIDListRouter[Circuit] = ...
