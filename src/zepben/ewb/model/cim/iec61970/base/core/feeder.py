...
from zepben.ewb.dataslot import MRIDDictRouter, dataslot, ValidatedDescriptor, MRIDDictAccessor, validate
...
class Feeder(EquipmentContainer):
    ...
    def _retype(self):
        ...
        self.normal_energized_lv_feeders: MRIDDictRouter[LvFeeder] = ...
        self.current_energized_lv_feeders: MRIDDictRouter[LvFeeder] = ...
