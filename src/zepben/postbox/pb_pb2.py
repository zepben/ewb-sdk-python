...
from zepben.cim.iec61970.base.core import Substation_pb2 as zepben_dot_cim_dot_iec61970_dot_base_dot_core_dot_Substation__pb2
...
_SUBSTATIONREQUEST = _descriptor.Descriptor(
  name='SubstationRequest',
  full_name='zepben.pb.SubstationRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='message_id', full_name='zepben.pb.SubstationRequest.message_id', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='substation', full_name='zepben.pb.SubstationRequest.substation', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SUBSTATIONRESPONSE = _descriptor.Descriptor(
  name='SubstationResponse',
  full_name='zepben.pb.SubstationResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='msg', full_name='zepben.pb.SubstationResponse.msg', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SUBSTATIONREQUEST.fields_by_name['substation'].message_type = zepben_dot_cim_dot_iec61970_dot_base_dot_core_dot_Substation__pb2._SUBSTATION
...
DESCRIPTOR.message_types_by_name['SubstationRequest'] = _SUBSTATIONREQUEST
...
DESCRIPTOR.message_types_by_name['SubstationResponse'] = _SUBSTATIONRESPONSE
...
SubstationRequest = _reflection.GeneratedProtocolMessageType('SubstationRequest', (_message.Message,), {
  'DESCRIPTOR' : _SUBSTATIONREQUEST,
  '__module__' : 'zepben.postbox.pb_pb2'
  # @@protoc_insertion_point(class_scope:zepben.pb.SubstationRequest)
  })
_sym_db.RegisterMessage(SubstationRequest)
...
SubstationResponse = _reflection.GeneratedProtocolMessageType('SubstationResponse', (_message.Message,), {
  'DESCRIPTOR' : _SUBSTATIONRESPONSE,
  '__module__' : 'zepben.postbox.pb_pb2'
  # @@protoc_insertion_point(class_scope:zepben.pb.SubstationResponse)
  })
_sym_db.RegisterMessage(SubstationResponse)
...
_NETWORKDATA = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='zepben.pb.NetworkData.createSubstation',
    index=13,
    containing_service=None,
    input_type=_SUBSTATIONREQUEST,
    output_type=_SUBSTATIONRESPONSE,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
