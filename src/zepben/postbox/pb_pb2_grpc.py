...
class NetworkDataStub(object):
  ...
  def __init__(self, channel):
    ...
    self.createSubstation = channel.unary_unary(
        '/zepben.pb.NetworkData/createSubstation',
        request_serializer=zepben_dot_postbox_dot_pb__pb2.SubstationRequest.SerializeToString,
        response_deserializer=zepben_dot_postbox_dot_pb__pb2.SubstationResponse.FromString,
        )
...
def add_NetworkDataServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'createSubstation': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=zepben_dot_postbox_dot_pb__pb2.SubstationRequest.FromString,
          response_serializer=zepben_dot_postbox_dot_pb__pb2.SubstationResponse.SerializeToString,
      ),
