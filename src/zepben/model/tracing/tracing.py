...
class BaseTraversal(Generic[T], ABC):
    ...
    conditions are evaluated, and each action is passed the current :class:`zepben.model.ConnectivityResult` as well as
    ...
    :func: action(cr: :class:`zepben.model.ConnectivityResult`, is_stopping: bool) -> None
    """
    def __init__(self,
                 start_item: T,
    ...
    async def trace(self, can_stop_on_start_item: bool = True):
        ...
        :param start_item: The starting point. Must implement :func:`zepben.model.ConductingEquipment::get_connectivity`
    ...
    async def _run_trace(self, can_stop_on_start_item: bool = True):
        ...
        :param start_item: The starting object to commence tracing. Must implement :func:`zepben.model.ConductingEquipment.get_connectivity`
...
class Traversal(BaseTraversal):
    ...
    The traversal also requires a :class:`zepben.model.tracing.tracker.Tracker` to be supplied. This gives flexibility
    ...
    def __init__(self,
        ...
        :param tracker: A :class:`zepben.model.tracing.Tracker` for tracking which items have been seen. If not provided
