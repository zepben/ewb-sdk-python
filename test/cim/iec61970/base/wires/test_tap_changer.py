...
tap_changer_args = [*power_system_resource_args, False, 1, 10, 2, 3, 4, 5.5]
...
def verify_tap_changer_constructor_kwargs(tc: TapChanger, control_enabled, neutral_u, high_step, low_step, neutral_step, normal_step, step, **kwargs):
...
def verify_tap_changer_constructor_args(tc: TapChanger):
    ...
    assert tc.control_enabled == tap_changer_args[-7]
    assert tc.neutral_u == tap_changer_args[-6]
