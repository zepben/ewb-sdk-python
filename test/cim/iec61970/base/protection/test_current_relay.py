...
from cim.iec61970.base.protection.test_protection_equipment import protection_equipment_kwargs, protection_equipment_args, \
    verify_protection_equipment_constructor_default, verify_protection_equipment_constructor_kwargs, verify_protection_equipment_constructor_args
from cim.property_validator import validate_property_accessor
from zepben.evolve import CurrentRelay, ProtectionKind, CurrentRelayInfo
...
current_relay_args = [*protection_equipment_args, 1.1, True, 2.2]


def test_current_relay_constructor_default():
    cr = CurrentRelay()

    verify_protection_equipment_constructor_default(cr)
...
def test_current_relay_constructor_kwargs(current_limit_1, inverse_time_flag, time_delay_1, **kwargs):
    ...
    verify_protection_equipment_constructor_kwargs(cr, **kwargs)
...
def test_current_relay_constructor_args():
    ...
    verify_protection_equipment_constructor_args(cr)
...
def test_current_relay_info_accessor():
    validate_property_accessor(CurrentRelay, CurrentRelayInfo, CurrentRelay.current_relay_info)
