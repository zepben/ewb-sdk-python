...
from zepben.evolve import NetworkService, AcLineSegment, Junction
...
def three_common_lines_network() -> NetworkService:
    ...
    # AcLineSegment1
    acls1 = AcLineSegment(mrid="acls1", length=1.0, per_length_impedance=plsi1, asset_info=wire_info)
    network.add(acls1)
    ...
    # AcLineSegment2
    acls2 = AcLineSegment(mrid="acls2", length=2.0, per_length_impedance=plsi1, asset_info=wire_info)
    network.add(acls2)
    ...
    # AcLineSegment3
    acls3 = AcLineSegment(mrid="acls3", length=3.0, per_length_impedance=plsi1, asset_info=wire_info)
    network.add(acls3)
