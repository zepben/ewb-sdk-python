...
from zepben.ewb import NetworkService, AcLineSegment
from zepben.ewb.services.network.network_service import connect
...
def multi_branch_common_lines_network() -> NetworkService:
    ...
    # AcLineSegment1
    a1 = AcLineSegment(mrid="a1", length=1.0, per_length_impedance=plsi)
    network.add(a1)
    ...
    # AcLineSegment6
    a6 = AcLineSegment(mrid="a6", length=6.0, per_length_impedance=plsi)
    network.add(a6)
    ...
    # AcLineSegment7
    a7 = AcLineSegment(mrid="a7", length=7.0, per_length_impedance=plsi)
    network.add(a7)
    ...
    # AcLineSegment8
    a8 = AcLineSegment(mrid="a8", length=8.0, per_length_impedance=plsi)
    network.add(a8)
