...
It also provides a lookup to be able to get the [DiagramObjects](https:#zepben.bitbucket.io/cim/evolve/iec61970/base/diagramlayout/diagramobject/) associated with any
identified object. Specifically:
- If the MRID is a diagram object, a list with just the diagram object is returned.
- If the MRID is a [Diagram](https:#zepben.bitbucket.io/cim/evolve/iec61970/base/diagramlayout/diagram/) all diagram
