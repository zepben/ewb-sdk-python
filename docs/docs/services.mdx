...
Because services work with [identified objects](http://zepben.bitbucket.io/cim/cim100/iec61970/base/core/identifiedobject/)
...
```python
from zepben.cimbend import NetworkService, Breaker, Junction, IdentifiedObject
...
```python
from zepben.cimbend import NetworkService, Breaker
...
```python
from zepben.cimbend import NetworkService, Breaker, Junction, ConductingEquipment
...
[PowerSystemResource](http://zepben.bitbucket.io/cim/evolve/iec61970/base/core/powersystemresource/) types, but also
data related types such as [AssetInfo](http://zepben.bitbucket.io/cim/evolve/iec61968/assets/assetinfo/) and
[Location](http://zepben.bitbucket.io/cim/evolve/iec61968/common/location/).

The network service also generates an index between power system resources and terminals and their corresponding
measurements. When you add a [Measurement](http://zepben.bitbucket.io/cim/evolve/iec61970/base/meas/measurement/)
...
```python
from zepben.cimbend import NetworkService, Analog, Accumulator, Measurement
...
It also provides a lookup to be able to get the [DiagramObjects](http://zepben.bitbucket.io/cim/evolve/iec61970/base/diagramlayout/diagramobject/) associated with any
identified object. Specifically:
- If the MRID is a diagram object, a list with just the diagram object is returned.
- If the MRID is a [Diagram](http://zepben.bitbucket.io/cim/evolve/iec61970/base/diagramlayout/diagram/) all diagram
...
```python
from zepben.cimbend import DiagramService, Diagram, DiagramObject
...
```python
from zepben.cimbend import NetworkService, Feeder, Breaker, resolver
...
(e.g their [Tariff](http://zepben.bitbucket.io/cim/evolve/iec61968/customers/tariff/)).
* The diagram service deals with things related to representing networks as diagrams
(see [Diagram](http://zepben.bitbucket.io/cim/evolve/iec61970/base/diagramlayout/diagram/) and
 [DiagramObject](http://zepben.bitbucket.io/cim/evolve/iec61970/base/diagramlayout/diagramobject/)).
