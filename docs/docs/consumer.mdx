...
with open('path/to/ca/bundle', 'rb') as f:
    ...
    async with connect_tls(host="ewb.zepben.com", rpc_port=443, ca=ca) as channel:
        client = SyncNetworkConsumerClient(channel)
...
async with connect_with_secret(host="ewb.zepben.com", rpc_port=443, ca=ca, key=key, cert=cert) as channel:
    client = SyncNetworkConsumerClient(channel)
...
async with connect_with_password(host="ewb.zepben.com", rpc_port=443, conf_address="https://ewb.zepben.com/ewb/auth", secure=True, client_id="some_client_id",
             username="user@email.com", password="password1") as channel:
    client = SyncNetworkConsumerClient(channel)
    # ...

# Client credentials configuration
async with connect_with_secret(host="ewb.zepben.com", rpc_port=443, conf_address="https://ewb.zepben.com/ewb/auth", secure=True, client_id="some_client_id",
